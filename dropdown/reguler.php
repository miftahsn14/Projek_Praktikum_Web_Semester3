...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary shadow fixed-top navbar-light bg-transparent">
        <div class="container">
            ...
            <a class="navbar-brand" href="#"><b>Data Reguler</b></a>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- EDIT -->
                                <a href="../php/edit.php?id_booking=<?php echo $row_booking['id_booking']; ?>&redirect=../dropdown/reguler.php" class="btn btn-primary action-btn" title="Edit">
                                    <i class="bi bi-pencil"></i> Edit
                                </a>

                                <!-- DELETE -->
                                <a href="../php/hapus.php?id_booking=<?php echo $row_booking['id_booking']; ?>&redirect=../dropdown/reguler.php" class="btn btn-danger action-btn" title="Delete">
