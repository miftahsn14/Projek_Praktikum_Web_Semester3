...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary shadow fixed-top navbar-light bg-transparent">
        <div class="container">
            ...
            <a class="navbar-brand" href="#"><b>Data Promo</b></a>
    ...
    <div class="content">
        <div class="table-responsive table-custom">
            <table class="table table-bordered text-center">
                ...
                <!-- Syntax untuk memunculkan data -->
                <?php
                $nomor = 1; //inisialisasi no di tabel
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- EDIT -->
                                <a href="../php/edit.php?id_booking=<?php echo $row_booking['id_booking']; ?>&redirect=../dropdown/promo.php" class="btn btn-primary action-btn" title="Edit">
                                    <i class="bi bi-pencil"></i> Edit
                                </a>

                                <!-- DELETE -->
                                <a href="../php/hapus.php?id_booking=<?php echo $row_booking['id_booking']; ?>&redirect=../dropdown/promo.php" class="btn btn-danger action-btn" title="Delete">
                ...
                <!-- TOTAL KEUNTUNGAN -->
                <tr>
                    <td colspan="4" class="text-start font-weight-bold">Total Keuntungan</td>
