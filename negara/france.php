...
<head>
    ...
    <style>
        .hero-section {
            position: relative;
            background: url('../gambar/fran.jpg') center/cover no-repeat;
            color: white;
            height: 400px;
            display: flex;
            align-items: center;
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="details-container">
                    ...
                    <p>If you're interested in history and culture, this itinerary will take you to historic cities like Lyon, Avignon, and Carcassonne. You'll explore ancient architecture, charming towns, and the rich history of France.
                    </p>
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            <span class="timeline-badge">Day 1 : 1 July 2025</span>
                            <div class="timeline-content d-flex align-items-start">
                             
                                <a href="https://maps.app.goo.gl/7y9qwg9y4jL6vxNHA" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    <h5 class="font-weight-bold">Arrival in Paris</h5>
                                    <p>Visit the Louvre Museum.
                                    </p>
                                </div>
                        ...
                        <div class="timeline-item">
                            <span class="timeline-badge">Day 2 : 2 July 2025</span>
                            <div class="timeline-content d-flex align-items-start">

                                <a href="https://maps.app.goo.gl/2KDieGLpSeYGqzzv9" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    <h5 class="font-weight-bold">Travel to Lyon
                                    </h5>
                                    <p>A culinary city with a rich history.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item">
                            <span class="timeline-badge">Day 3 : 3 July 2025</span>
                            <div class="timeline-content d-flex align-items-start">
                                <a href="https://maps.app.goo.gl/Kzb6gHygp2e85RRu9" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    <h5 class="font-weight-bold">Avignon</h5>
                                    <p>Learn about the fascinating history of the Avignon Papacy.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item no-point">
                            <div class="timeline-content d-flex align-items-start">
                                ...
                                <a href="https://maps.app.goo.gl/bT4amq5Fzjq2yFXX9" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    <h5 class="font-weight-bold">Rhône River</h5>
                                    <p>Boat trip on the Rhône River.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item">
                            <span class="timeline-badge">Day 4 : 4 July 2025</span>
                            <div class="timeline-content d-flex align-items-start">
                            
                                <a href="https://maps.app.goo.gl/RtU9dArQ2dBvnQkH8" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    <h5 class="font-weight-bold">Explore the city of Cannes</h5>
                                    <p>An international film center and a holiday destination for celebrities.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item">
                            <span class="timeline-badge">Day 5 : 5 July 2025</span>
                            <div class="timeline-content d-flex align-items-start">
                               
                                <a href="https://maps.app.goo.gl/SU4RLZQjUWDAAjHYA" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    <h5 class="font-weight-bold">Musee d'Orsay
                                    </h5>
                                    <p>An Impressionist art museum.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item">
                            <span class="timeline-badge">Day 6 : 6 July 2025</span>
                            <div class="timeline-content d-flex align-items-start">
                              
                                <a href="https://maps.app.goo.gl/ij1dapmxM4iPij228" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    <h5 class="font-weight-bold">Saint-Germain-des-Pres
                                    </h5>
                                    <p>Shop in Saint-Germain-des-Prés and enjoy the bohemian atmosphere of Paris.
                ...
                <div class="col-md-4">
                    <div class="details-sidebar">
                        ...
                        <p><strong>Departure Date:</strong> July 1, 2025</p>
                        <p><strong>Return Date:</strong> July 6, 2025</p>
                        <div class="disc mb-1">Save more on your vacation! Discounts 5% for groups of more than 4 people!</div>
                        <div class="price-tag">Starting from IDR 27,000,000</div>
                        ...
                        <form id="bookingForm" action="../php/booking.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="tanggal" class="form-control" value="1 - 6 July 2025" disabled>
                            </div>
                            <br>
