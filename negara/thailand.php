...
<head>
    ...
    <style>
        .hero-section {
            position: relative;
            background: url('../gambar/thh.jpg') center/cover no-repeat;
            color: white;
            height: 400px;
            display: flex;
            align-items: center;
...
<body>
    ...
    <section class="hero-section text-center">
        <h1>THAILAND: A Journey Through Land of Smiles
        </h1>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="details-container">
                    ...
                    <p>Embark on an unforgettable 6-day adventure through Thailand, a land of vibrant culture, stunning beaches, and delicious cuisine. This tour offers a perfect blend of exciting city life, serene temples, and tropical paradise.
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-item">
                            <span class="timeline-badge">Day 1 : 1 May 2025</span>
                            <div class="timeline-content d-flex align-items-start">
                              
                                <a href="https://maps.app.goo.gl/V3kkqi9esgYfFc7K8" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    <h5 class="font-weight-bold">Arrive in Bangkok
                                    </h5>
                                    <p>Explore the magnificent Grand Palace and the iconic reclining Buddha at Wat Pho.
                        ...
                        <div class="timeline-item">
                            <span class="timeline-badge">Day 2 : 2 May 2025</span>
                            <div class="timeline-content d-flex align-items-start">

                                <a href="https://maps.app.goo.gl/N9qKTY4Rz4MzLk7D9" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    <h5 class="font-weight-bold">Chao Phraya

                                    </h5>
                                    <p>Enjoy a relaxing cruise along the Chao Phraya River.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item no-point">
                            <div class="timeline-content d-flex align-items-start">
                                ...
                                <a href="https://maps.app.goo.gl/uNsRVY55gDRevKbs7" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    <h5 class="font-weight-bold">Wat Arun</h5>
                                    <p>Visit the stunning Wat Arun, the Temple of Dawn.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item">
                            <span class="timeline-badge">Day 3 : 3 May 2025</span>
                            <div class="timeline-content d-flex align-items-start">
                             
                                <a href="https://maps.app.goo.gl/CpV9esEuC7bwR7ie9" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    <h5 class="font-weight-bold">Wat Mahathat
                                    </h5>
                                    <p>Visit iconic temples such as Wat Mahathat
                        ...
                        <div class="timeline-item">
                            <span class="timeline-badge">Day 4 : 4 May 2025</span>
                            <div class="timeline-content d-flex align-items-start">
                           
                                <a href="https://maps.app.goo.gl/DpXa7wwYg9YP8zYm7" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    <h5 class="font-weight-bold">Pattaya Beach</h5>
                                    <p>Take a boat trip to Coral Island
                        ...
                        <div class="timeline-item">
                            <span class="timeline-badge">Day 5 : 5 May 2025</span>
                            <div class="timeline-content d-flex align-items-start">
                            
                                <a href="https://maps.app.goo.gl/HYoueMmi4CXCgo1E7" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    <h5 class="font-weight-bold">Elephant Sanctuary

                                    </h5>
                                    <p>Visit an ethical elephant sanctuary
                        ...
                        <div class="timeline-item">
                            <span class="timeline-badge">Day 6 : 6 May 2025</span>
                            <div class="timeline-content d-flex align-items-start">
                             
                                <a href="https://maps.app.goo.gl/3TN57usNVnSueSKC8" target="_blank" class="me-3">
                                    <i class="bi bi-geo-alt-fill text-primary"></i>
                                </a>
                                <div>
                                    ...
                                    <p>Enjoy a leisurely breakfast and do some last-minute shopping
                ...
                <div class="col-md-4">
                    <div class="details-sidebar">
                        ...
                        <p><strong>Departure Date:</strong> May 1, 2025</p>
                        <p><strong>Return Date:</strong> May 6, 2025</p>
                        <div class="disc mb-1">Save more on your vacation! Discounts 5% for groups of more than 4 people!</div>
                        <div class="price-tag">Starting from IDR 20,000,000</div>
                        ...
                        <!-- HIDDEN id_tour -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="tanggal" class="form-control" value="1 - 6 May 2025" disabled>
                            </div>
                            <br>
